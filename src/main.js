...
/* ---------------- TESTIMONIALS DATA ---------------- */
const testis = [
  {q:" ТОВ «Універсальні експертні рішення» провели повний аудит нашого цеху за тиждень і склали чіткий план усунення зауважень. Перевірку Держпраці пройшли без жодного зауваження.",n:"Олена Ковальчук",r:"Директорка з виробництва, МеталПром",img:"https://picsum.photos/id/1027/100/100"},
...
const faqs = [
  ...
  {q:"Чи надаєте супровід під час перевірки Держпраці?",a:"Так, представник  ТОВ «Універсальні експертні рішення» присутній під час перевірки та представляє інтереси клієнта у спілкуванні з контролюючим органом."},
];
